    	...
    	<div class="container">
    		<div class="blog-article">
                <div class="blog-top-details">
                    ...
                    <div class="heading">
                        <p class="posted-date">Posted on <?php print format_date($node->created, 'custom', 'F j Y');?>
                        <?php if($node->field_byline['und'][0]['value']): ?> by <?php print $node->field_byline['und'][0]['value']; ?><?php endif; ?></p>
